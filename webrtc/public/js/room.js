...
async function toggleRecording() {
    const recordButton = document.querySelector('.record i');
    ...
    if (!isRecording) {
        ...
        // Video recording
        const videoStream = document.getElementById('vd1').srcObject;
        ...
        mediaRecorder.onstop = () => {
            ...
            a.href = videoUrl;
            a.download = `virtumeet-recording-${new Date().toISOString()}.webm`;
            a.click();
        };

        // Audio recording (separate stream for audio only)
        ...
        audioRecorder.onstop = () => {
            ...
            const a = document.createElement('a');
            a.href = audioUrl;
            a.download = `virtumeet-audio-${new Date().toISOString()}.webm`;
            a.click();
        };
